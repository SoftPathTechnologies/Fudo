...
export default function Cart() {
    ...
    const total = () => cartData.pizzas.reduce((a, b) => a + b.qauntity * b.price, 0)
    return (<Layout>
        <div className={
            css.container
        }>
            ...
            <div className={
                ...
                <div className={
                    ...
                    <button className="btn"
                        onClick={handleOnDelivery}>Pay on Delivery</button>
                    <button className="btn">Pay Now</button>
                </div>
            </div>
            <Toaster/>
            <PayOnDeliveryModal opened= {paymentMethod === 0}
